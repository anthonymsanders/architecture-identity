...
# Microsoft Hybrid Guidance: Entra ID and Active Directory

The following sections provide Microsoft-aligned guidance for addressing each of the common identity challenges listed above. All guidance assumes a **hybrid environment** using **Microsoft Entra ID** (formerly Azure AD) alongside **on-premises Active Directory Domain Services (AD DS)**, connected via **Microsoft Entra Connect** (formerly Azure AD Connect).

---

## Small Organisation Challenges: Microsoft Hybrid Guidance
...
## Medium Organisation Challenges: Microsoft Hybrid Guidance
...
## Large Organisation Challenges: Microsoft Hybrid Guidance
